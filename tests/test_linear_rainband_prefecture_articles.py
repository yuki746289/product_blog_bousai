...
class LinearRainbandPrefectureBatch1Tests(unittest.TestCase):
    ...
    def test_history_and_evacuation_are_not_generic_placeholders(self):
        markers = {
            "B082": ("1993", "2023年8月9〜10日", "2024年11月9日", "2025年6月9日", "薩摩", "指定緊急避難場所"),
            "B083": ("2023年8月9〜10日", "2024年8月29日", "2025", "河川水位"),
            "B084": ("2012", "2020", "2023年7月3日", "2023年8月9日", "2025年9月10日", "球磨川"),
            "B085": ("1982", "2023", "2025年8月11日", "2025年9月10日", "指定緊急避難場所"),
            "B086": ("2017", "2023年8月10日", "2025年8月10日", "雨量・水位"),
        }
