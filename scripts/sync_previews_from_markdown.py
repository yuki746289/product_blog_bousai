...
# Updated: 2026-09-09 14:54 JST
"""Compatibility wrapper around the preview synchronizer.

B003/B008/B010 were omitted from the original synchronization set even though
Markdown is the editorial source of truth. Keep the reviewed core unchanged and
extend its target set here so CI, local deploy and production deploy all use the
same correction without duplicating the large renderer implementation.
"""
...
EXTRA_SYNC_ARTICLE_IDS = {"B003", "B008", "B010"}
