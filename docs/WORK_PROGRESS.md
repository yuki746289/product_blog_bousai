...
- remaining: 最新PR headのCI最終確認 / PR #129説明更新 / デプロイ前報告の最終確認 / ユーザー明示許可 / mainマージ・本番反映 / 本番スモーク / ユーザー確認
- next_action: 最新PR headのContent freshness checkを確認し、修正概要・検証結果・残課題をユーザーへ報告する。明示許可まではデプロイしない。
