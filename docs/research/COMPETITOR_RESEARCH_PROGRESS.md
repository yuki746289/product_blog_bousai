...
| 停電×マンション | `EXPAND B022 / P1` | `INITIAL_DONE` | サイト全体台帳に初期結果あり |
| 災害×車中泊 | `EXPAND B044 / P1` | `INITIAL_DONE` | サイト全体台帳に初期結果あり |
...
| 6 | B044 | 在宅・車中泊避難者支援への接続 | 詳細調査待ち |
| 7 | B022 | 給水ポンプ・非常用水栓等 | GSC平均5位台につき変更保留 |
