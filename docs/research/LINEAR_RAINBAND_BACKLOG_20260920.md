...
- actual_image_embed_status: `USER_APPROVED`
- HTML/CSS図解と実画像は同一成果物として扱わず、V01-V05を再オープン
- 2026-09-21: PR #103で実画像掲載、PR #104で本番画像スモークを追加。deploy run #85で本番4ページ・5画像HTTP 200を確認。
- 2026-09-21: ユーザーが本番表示・配置を確認し承認。V01-V05を正式完了。
